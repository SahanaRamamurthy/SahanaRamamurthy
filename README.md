...
- **Analysing** - revenue diagnostics, fraud detection, compliance risk, credit risk
...
- Built credit risk models using the **IRB approach** — Logistic Regression scorecard + Gradient Boosting challenger — for PD, LGD, and EAD estimation (AUC: 0.82)
...
- Built a **cross-filter interactive dashboard** in Plotly Dash — click any chart element and all 10 panels update instantly, powered live by **Google BigQuery**
